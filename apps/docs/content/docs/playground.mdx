...
```bash
git clone https://github.com/next-safe-action/next-safe-action.git
cd next-safe-action
pnpm install
```
...
<Cards>
	<Card title="Playground source" href="https://github.com/next-safe-action/next-safe-action/tree/main/apps/playground">
