...
type inferredTestActionInput = InferSafeActionFnInput<typeof testAction>; // [!code highlight]
/*
{
  clientInput: {
    username: string;
...
type inferredTestActionResult = InferSafeActionFnResult<typeof testAction>; // [!code highlight]
/*
{
  data?: {
    successful: boolean;
...
// the `next` function.
type inferredAuthMiddlewareNextCtx = InferMiddlewareFnNextCtx<typeof authMiddleware>; // [!code highlight]
/*
{
  sessionId: string;
  userId: string;
...
type inferredSafeActionClientCtx = InferCtx<typeof actionClient>; // [!code highlight]
/*
{
  sessionToken: string;
} & {
...
type inferredMiddlewareMetadata = InferMetadata<typeof authMiddleware>; // [!code highlight]
/*
{
  actionName: string;
}
...
type inferredServerError = InferServerError<typeof testAction>; // [!code highlight]
/*
{
  errorMessage: string;
}
...
type inferredTestActionHookReturn = InferUseActionHookReturn<typeof testAction>; // [!code highlight]
/*
{
...
// to `any`.
type inferredTestActionOptimisticHookReturn = InferUseOptimisticActionHookReturn< // [!code highlight]
  typeof testAction, // [!code highlight]
  { myServerState: { foo: string } } // [!code highlight]
>; // [!code highlight]
/*
{
  execute: (input: { username: string }) => void;
...
type inferredTestActionStateHookReturn = InferUseStateActionHookReturn<typeof testAction>; // [!code highlight]
/*
{
  execute: (input: { username: string }) => void;
  input: { username: string };
