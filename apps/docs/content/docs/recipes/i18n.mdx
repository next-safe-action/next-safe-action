...
async function getSchema() { // [!code highlight]
  // This is an example of a i18n setup. // [!code highlight]
  const t = await getTranslations(); // [!code highlight]
  return mySchema(t); // this is the schema that will be used to validate and parse the input // [!code highlight]
} // [!code highlight]

export const myAction = actionClient
  .inputSchema(getSchema) // [!code highlight]
