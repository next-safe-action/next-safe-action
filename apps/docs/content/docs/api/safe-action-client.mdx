...
<TypeTable
	type={{
		middlewareFn: {
			...
			type: "MiddlewareFn<ServerError, MD, Ctx, Ctx & NextCtx>",
		},
	}}
/>
...
<TypeTable
	type={{
		data: {
			...
			type: "MD (inferred from metadata schema)",
		},
	}}
/>
...
<TypeTable
	type={{
		...
		"utils.handleValidationErrorsShape": {
			...
			type: "(ve: ValidationErrors, utils) => Promise<CVE>",
...
<TypeTable
	type={{
		serverCodeFn: {
			...
			type: "ServerCodeFn<MD, Ctx, IS, BAS, Data>",
		},
		utils: {
...
<TypeTable
	type={{
		...
		throwValidationErrors: {
			...
			type: "boolean | { overrideErrorMessage: (ve: CVE) => Promise<string> }",
			default: "false",
		},
		onSuccess: {
