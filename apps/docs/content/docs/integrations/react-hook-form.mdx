...
<TypeTable
	type={{
		...
		hookFormResolver: {
			...
			type: "Resolver<InferInput<S>, FormContext, InferOutput<S>>",
		},
		props: {
			description: "Optional props for the action hook, form hook, and error mapper.",
			type: "HookProps<ServerError, S, CVE, Data, FormContext>",
			default: "undefined",
		},
	}}
/>
...
<TypeTable
	type={{
		...
		actionProps: {
			description: "Callbacks passed to the underlying useAction hook (onSuccess, onError, onExecute, onSettled, etc.).",
...
<TypeTable
	type={{
		...
		props: {
			...
			type: "HookProps & { actionProps: { currentState: State; updateFn: (state: State, input: InferInput<S>) => State } }",
		},
	}}
/>
